...
| `scripts/publish-image.sh` | Build and tag a registry-pullable pila image for fly.io Machines (no `HOST_UID/HOST_GID` coupling). See `docs/IMPLEMENTATION.md` §0.5 *Registry publish path*. |
